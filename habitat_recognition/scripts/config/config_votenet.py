...
class ConfigVoteNet():
    def __init__(self) -> None:
        ...
        self.mean_size_arr = np.load('/home/junting/project_cvl/votenet/scannet/meta_data/scannet_means.npz')['arr_0']
        self.type_mean_size = {}
        ...
        self.num_input_channel = int(self.use_color)*3 + int(self.use_height)*1
        self.vote_factor = 1
        ...
        self.eval_dir = "/home/junting/habitat_ws/src/habitat_detect_segment/eval_output"
